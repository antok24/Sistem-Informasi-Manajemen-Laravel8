!(function () {
    ...
    const D = {
        ...
        m(e, t, i) {
            ...
            if (isNaN(a)) {
                ...
                return (
                    (a = i.monthsShort.findIndex(n)) < 0 &&
                        (a = i.months.findIndex(n)),
                    a < 0 ? NaN : s.setMonth(a)
                );
            }
            return (
                s.setMonth(a),
    ...
    function x(e) {
        ...
        return (y[e] = {
            parser(e, t) {
                const i = e.split(k).reduce((e, t, i) => {
                    if (t.length > 0 && s[i]) {
                        const a = s[i][0];
                        void 0 !== D[a] && (e[a] = t);
                    }
    ...
    const O = new WeakMap(),
        { addEventListener: C, removeEventListener: V } = EventTarget.prototype;
    function F(e, t) {
        let i = O.get(e);
        i || ((i = []), O.set(e, i)),
            t.forEach((e) => {
    ...
    function H(e) {
        e.firstChild && (e.removeChild(e.firstChild), H(e));
    }
    const { language: $, format: j, weekStart: K } = L;
    function P(e, t) {
    ...
    function q(t, s) {
        ...
        if (a.language) {
            ...
            if (
                ...
                o = n.language = e;
                const t = c || r[$];
                (c = Object.assign({ format: j, weekStart: K }, r[$])),
                    o !== $ && Object.assign(c, r[o]),
                    (n.locale = c),
                    d === t.format && (d = n.format = c.format),
                    m === t.weekStart &&
                        ((m = n.weekStart = c.weekStart),
                        (n.weekEnd = R(c.weekStart)));
            }
        }
        if (a.format) {
        ...
        if (
            (void 0 !== a.minDate &&
                ((g = null === a.minDate ? l(0, 0, 1) : _(a.minDate, d, c, g)),
                delete a.minDate),
            void 0 !== a.maxDate &&
                ((k = null === a.maxDate ? void 0 : _(a.maxDate, d, c, k)),
                delete a.maxDate),
            k < g
                ? ((f = n.minDate = k), (h = n.maxDate = g))
                : (f !== g && (f = n.minDate = g),
                  h !== k && (h = n.maxDate = k)),
            a.datesDisabled &&
            ...
            const e = S(a.defaultViewDate, d, c);
            void 0 !== e && (n.defaultViewDate = e), delete a.defaultViewDate;
        }
        if (void 0 !== a.weekStart) {
            const e = Number(a.weekStart) % 7;
            isNaN(e) || ((m = n.weekStart = e), (n.weekEnd = R(e))),
                delete a.weekStart;
        }
        if (
            (a.daysOfWeekDisabled &&
                ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(P, [])),
                delete a.daysOfWeekDisabled),
            a.daysOfWeekHighlighted &&
                ((n.daysOfWeekHighlighted = a.daysOfWeekHighlighted.reduce(
                    P,
                    []
                )),
        ...
        a.dateDelimiter &&
            ((n.dateDelimiter = String(a.dateDelimiter)),
            delete a.dateDelimiter);
        let y = u;
        void 0 !== a.maxView && ((y = I(a.maxView, u)), delete a.maxView),
            y !== u && (u = n.maxView = y);
        let D = p;
        if (
            (void 0 !== a.startView &&
                ((D = I(a.startView, D)), delete a.startView),
            (D = u < D ? u : D) !== p && (n.startView = D),
            a.prevArrow)
        ) {
    ...
    class G extends X {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek &&
                (t.showDaysOfWeek
                    ? (T(this.dow),
                      this.calendarWeeks && T(this.calendarWeeks.dow))
                    : (Y(this.dow),
        ...
        updateFocus() {
            ...
            (this.first = s),
                (this.last = l(t, i + 1, 0)),
                (this.start = a),
                (this.switchLabel = M(e, this.switchLabelFormat, this.locale)),
                (this.focused = this.picker.viewDate);
        }
        updateSelection() {
            const { dates: e, range: t } = this.picker.datepicker;
        ...
        render() {
            ...
            Array.from(this.grid.children).forEach((e, t) => {
                ...
                if (
                    ...
                    a > e && a < t && s.add("range"),
                        a === e && s.add("range-start"),
                        a === t && s.add("range-end");
                }
                this.selected.includes(a) && s.add("selected"),
            ...
            this.grid
                ...
                Array.from(this.grid.children).forEach((i) => {
                    ...
                    s > e && s < t && a.add("range"),
                        ...
                        s === t && a.add("range-end"),
                        this.selected.includes(s) && a.add("selected"),
        ...
        render() {
            ...
            Array.from(this.grid.children).forEach((a, n) => {
                ...
                (a.className = `datepicker-cell ${this.cellClass}`),
                    (a.textContent = this.monthNames[n]),
                    (t ||
                        (i && n < this.minMonth) ||
                        (s && n > this.maxMonth)) &&
                        r.add("disabled"),
                    ...
                    this.beforeShow &&
                        this.performBeforeHook(a, n, l(this.year, n, 1));
            });
        }
        refresh() {
            const e = this.selected[this.year] || [];
    ...
    class Z extends X {
        ...
        init(e, t = !0) {
            ...
            t &&
                ...
                this.grid.appendChild(W(r("span", 12)))),
                super.init(e);
        }
        setOptions(t) {
            if (
        ...
        updateFocus() {
            ...
            (this.first = t),
                ...
                (this.switchLabel = `${t}-${i}`),
                (this.focused = g(e, this.step));
        }
        updateSelection() {
            this.selected = this.picker.datepicker.dates.reduce(
                (e, t) => i(e, g(t, this.step)),
                []
            );
        }
        render() {
            ...
            this.grid.querySelectorAll(".selected, .focused").forEach((e) => {
                ...
                Array.from(this.grid.children).forEach((e) => {
                    const t = Number(e.textContent),
                        i = e.classList;
                    this.selected.includes(t) && i.add("selected"),
    ...
    function ae(t, i) {
        ...
        if (
            ...
            void 0 !== i.todayBtn &&
                (i.todayBtn ? T(t.controls.todayBtn) : Y(t.controls.todayBtn)),
        ...
        void 0 !== i.clearBtn &&
            (i.clearBtn ? T(t.controls.clearBtn) : Y(t.controls.clearBtn));
    }
    function ne(e) {
    ...
    class oe {
                    ...
                    [
                        ...
                        function (e, t) {
                            ...
                            if (i && !i.classList.contains("disabled"))
                                switch (e.picker.currentView.id) {
                                    case 0:
                                        e.setDate(Number(i.dataset.date));
                                        break;
                                    case 1:
                                        se(e, Number(i.dataset.month));
                                        break;
                                    default:
                                        se(e, Number(i.dataset.year));
                                }
                        }.bind(null, e),
                    ],
                    [
        ...
        show() {
            ...
            if (!e.inline) {
                const t = de(e.inputField);
                t !== de(e.config.container)
                    ? (this.element.dir = t)
        ...
        place() {
            ...
            let p,
                m,
                g,
                { x: w, y: k } = i.orientation;
            a === document.body
                ? ((p = window.scrollY), (m = l + window.scrollX), (g = h + p))
                : ((m = l - d), (g = h - o + (p = a.scrollTop))),
                "auto" === w &&
                    (m < 0
                        ? ((w = "left"), (m = 10))
                        : (w =
                ...
                e.add(`datepicker-orient-${k}`, `datepicker-orient-${w}`),
                (t.top = g ? `${g}px` : g),
                (t.left = m ? `${m}px` : m);
        }
        ...
        changeFocus(e) {
            return (
                (this._renderMethod = re(this, e) ? "render" : "refreshFocus"),
        ...
        update() {
            const e = ne(this.datepicker);
            return (
                (this._renderMethod = re(this, e) ? "render" : "refresh"),
                this.views.forEach((e) => {
    ...
    function ce(e, t, i, s) {
        ...
        void 0 !==
            (c = (function e(t, i, s, n, r, d) {
                if (a(t, r, d)) return n(t) ? e(i(t, s), i, s, n, r, d) : t;
            })(c, d, i < 0 ? -r : r, o, n.minDate, n.maxDate)) &&
            e.picker.changeFocus(c).render();
    }
    function le(e, t) {
        return e.map((e) => M(e, t.format, t.locale)).join(t.dateDelimiter);
    }
    function he(e, t, i) {
        if (0 === e.length) return i ? void 0 : [];
        let s = e.reduce((e, i) => {
            const s = S(i, t.format, t.locale);
            return (
                void 0 === s ||
                    !a(s, t.minDate, t.maxDate) ||
                    e.includes(s) ||
                    t.datesDisabled.includes(s) ||
                    t.daysOfWeekDisabled.includes(new Date(s).getDay()) ||
                    e.push(s),
                e
            );
        }, []);
        return 0 !== s.length
            ? (i &&
                  t.multidate &&
                  (s = s.reduce(
                      (e, t) => (i.includes(t) || e.push(t), e),
                      i.filter((e) => !s.includes(e))
                  )),
              t.maxNumberOfDates && s.length > t.maxNumberOfDates
                  ? s.slice(-1 * t.maxNumberOfDates)
                  : s)
            : void 0;
    }
    class ue {
        constructor(e, t = {}, i) {
            ...
            if (n)
                (a.container = e),
                    (d = s(e.dataset.date, a.dateDelimiter)),
                ...
                const i = t.container
                    ...
                    : null;
                i && (a.container = i),
                    (r = this.inputField = e).classList.add("datepicker-input"),
                    (d = s(r.value, a.dateDelimiter));
            }
            (this.dates = he(d, a) || []),
                i &&
                    "DateRangePicker" === i.constructor.name &&
                    ((this.rangepicker = i),
            ...
            const o = (this.picker = new oe(this));
            if (n) this.show();
            else {
                ...
                F(this, [
                    [
                        ...
                        function (e, t) {
                            if ("Tab" === t.key)
                                return e.refresh("input"), void e.hide();
        ...
        static formatDate(e, t, i) {
            return M(e, t, (i && B[i]) || B.en);
        }
        static parseDate(e, t, i) {
            return S(e, t, (i && B[i]) || B.en);
        }
        static get locales() {
            return B;
        }
        ...
        setOptions(e) {
            ...
            i.maxView < s
                ? t.changeView(i.maxView)
                : void 0 === i.startView ||
                  t.active ||
                  i.startView === s ||
                  t.changeView(i.startView),
                this.refresh();
        }
        show() {
        ...
        setDate(...e) {
            const i = [...e],
                s = { clear: !1, render: !0, autohide: this.config.autohide },
                a = t(e);
            "object" != typeof a ||
                Array.isArray(a) ||
                a instanceof Date ||
            ...
            const n = Array.isArray(i[0]) ? i[0] : i,
                ...
                d = he(n, this.config, r);
            d &&
                (d.toString() !== this.dates.toString()
                    ? ((this.dates = d),
                      s.render
                          ? (this.picker.update(), this.refresh())
                          : this.refresh("input"),
                      ee(this, "changeDate"))
                    : this.refresh("input"),
                s.render && s.autohide && this.hide());
        }
        update(e) {
            if (this.inline) return;
            const t = Object.assign({ autohide: !1 }, e),
                i = he(
                    s(this.inputField.value, this.config.dateDelimiter),
                    this.config
                );
            i &&
                (i.toString() !== this.dates.toString()
                    ? ((this.dates = i),
                      this.picker.update(),
                      this.refresh(),
                      ee(this, "changeDate"))
                    : this.refresh("input"),
                t.autohide && this.hide());
        }
        refresh(e) {
            "input" !== e && this.picker.render(),
                this.inline ||
                    "picker" === e ||
                    (this.inputField.value = le(this.dates, this.config));
        }
        enterEditMode() {
            this.inline ||
                !this.picker.active ||
    ...
    function pe(e, t, i, s) {
        return F(e, [[i, "changeDate", t]]), new ue(i, s, e);
    }
    function me(e, t) {
        ...
        void 0 !== d && void 0 !== o
            ? 0 === n && d > o
                ? (s[0].setDate(o, a), s[1].setDate(d, a))
                : 1 === n && d < o && (s[0].setDate(d, a), s[1].setDate(o, a))
            : e.allowOneSidedRange ||
              (void 0 === d && void 0 === o) ||
              ((a.clear = !0), s[r].setDate(s[n].dates, a)),
    ...
    (window.Datepicker = ue),
        (window.DateRangePicker = class {
            constructor(e, t = {}) {
                ...
                const s = me.bind(null, this),
                    a = fe(t);
                (this.datepickers = [
                    pe(this, s, this.inputs[0], a),
                    pe(this, s, this.inputs[1], a),
                ]),
                    void 0 !== this.dates[0]
                        ? me(this, { target: this.inputs[0] })
                        : void 0 !== this.dates[1] &&
                          me(this, { target: this.inputs[1] });
            }
            get dates() {
                if (this.datepickers)
                    return [
            ...
            getDates(e) {
                const t = e
                    ? (t) => M(t, e, this.datepickers[0].config.locale)
                    : (e) => new Date(e);
