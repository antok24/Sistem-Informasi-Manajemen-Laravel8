var Datepicker = (function () {
    ...
    const C = new WeakMap(),
        { addEventListener: O, removeEventListener: V } = EventTarget.prototype;
    function F(e, t) {
        let i = C.get(e);
        i || ((i = []), C.set(e, i)),
            t.forEach((e) => {
    ...
    const { language: H, format: $, weekStart: j } = B;
    function K(e, t) {
    ...
    function q(t, s) {
        ...
        if (a.language) {
            ...
            if (
                ...
                d = n.language = e;
                const t = c || r[H];
                (c = Object.assign({ format: $, weekStart: j }, r[H])),
                    d !== H && Object.assign(c, r[d]),
                    (n.locale = c),
                    o === t.format && (o = n.format = c.format),
                    m === t.weekStart &&
                        ((m = n.weekStart = c.weekStart),
                        (n.weekEnd = P(c.weekStart)));
            }
        }
        if (a.format) {
        ...
        if (
            (void 0 !== a.minDate &&
                ((w = null === a.minDate ? l(0, 0, 1) : _(a.minDate, o, c, w)),
                delete a.minDate),
            void 0 !== a.maxDate &&
                ((y = null === a.maxDate ? void 0 : _(a.maxDate, o, c, y)),
                delete a.maxDate),
            y < w
                ? ((f = n.minDate = y), (h = n.maxDate = w))
                : (f !== w && (f = n.minDate = w),
                  h !== y && (h = n.maxDate = y)),
            a.datesDisabled &&
        ...
        if (void 0 !== a.weekStart) {
            ...
            isNaN(e) || ((m = n.weekStart = e), (n.weekEnd = P(e))),
                delete a.weekStart;
        }
        if (
            (a.daysOfWeekDisabled &&
                ((n.daysOfWeekDisabled = a.daysOfWeekDisabled.reduce(K, [])),
        ...
        let D = u;
        void 0 !== a.maxView && ((D = I(a.maxView, u)), delete a.maxView),
            D !== u && (u = n.maxView = D);
        let k = p;
        if (
            (void 0 !== a.startView &&
                ((k = I(a.startView, k)), delete a.startView),
            (k = u < k ? u : k) !== p && (n.startView = k),
            a.prevArrow)
        ) {
    ...
    class X extends z {
        ...
        setOptions(t) {
            ...
            void 0 !== t.showDaysOfWeek &&
                (t.showDaysOfWeek
                    ...
                    : (A(this.dow),
                      this.calendarWeeks && A(this.calendarWeeks.dow))),
                i &&
        ...
        updateFocus() {
            ...
            (this.first = s),
                (this.last = l(t, i + 1, 0)),
                (this.start = a),
                (this.switchLabel = S(e, this.switchLabelFormat, this.locale)),
            ...
            if (
                (e(t, "minDate") &&
                    (void 0 === t.minDate
                        ...
                        : ((this.minYear = w(t.minDate, this.step)),
                          (this.minDate = l(this.minYear, 0, 1)))),
                e(t, "maxDate") &&
                    (void 0 === t.maxDate
                        ? (this.maxYear = this.maxDate = void 0)
                        : ((this.maxYear = w(t.maxDate, this.step)),
    ...
    function se(t, i) {
        ...
        if (
            ...
            void 0 !== i.todayBtn &&
                (i.todayBtn ? Y(t.controls.todayBtn) : A(t.controls.todayBtn)),
        ...
        void 0 !== i.clearBtn &&
            (i.clearBtn ? Y(t.controls.clearBtn) : A(t.controls.clearBtn));
    }
    function ae(e) {
    ...
    function ne(e, t) {
        const i = new Date(e.viewDate),
            s = new Date(t),
            { id: a, year: n, first: r, last: o } = e.currentView,
            d = s.getFullYear();
        switch (
            ((e.viewDate = t),
            d !== i.getFullYear() && Z(e.datepicker, "changeYear"),
            s.getMonth() !== i.getMonth() && Z(e.datepicker, "changeMonth"),
            a)
        ) {
            case 0:
                return t < r || t > o;
    ...
    class oe {
        ...
        place() {
            ...
            let p,
                m,
                w,
                { x: g, y: y } = i.orientation;
            a === document.body
                ? ((p = window.scrollY), (m = l + window.scrollX), (w = h + p))
                : ((m = l - o), (w = h - d + (p = a.scrollTop))),
                "auto" === g &&
                    (m < 0
                        ? ((g = "left"), (m = 10))
                        : (g =
                ...
                e.add(`datepicker-orient-${y}`, `datepicker-orient-${g}`),
                (t.top = w ? `${w}px` : w),
                (t.left = m ? `${m}px` : m);
        }
        ...
        changeFocus(e) {
            return (
                (this._renderMethod = ne(this, e) ? "render" : "refreshFocus"),
        ...
        update() {
            ...
            return (
                (this._renderMethod = ne(this, e) ? "render" : "refresh"),
                this.views.forEach((e) => {
    ...
    function de(e, t, i, s) {
        ...
        switch (n.id) {
            ...
            default:
                (c = f(c, i * (s ? 4 : 1) * r)),
                    (o = f),
                    (d = (e) => n.disabled.includes(w(e, r)));
        }
        void 0 !==
            (c = (function e(t, i, s, n, r, o) {
                if (a(t, r, o)) return n(t) ? e(i(t, s), i, s, n, r, o) : t;
            })(c, o, i < 0 ? -r : r, d, n.minDate, n.maxDate)) &&
    ...
    return class {
        constructor(e, t = {}, i) {
            ...
            if (n)
                (a.container = e),
                    (o = s(e.dataset.date, a.dateDelimiter)),
        ...
        setDate(...e) {
            ...
            o &&
                (o.toString() !== this.dates.toString()
                    ? ((this.dates = o),
                      s.render
        ...
        refresh(e) {
            "input" !== e && this.picker.render(),
                this.inline ||
                    "picker" === e ||
                    (this.inputField.value = ce(this.dates, this.config));
        }
        enterEditMode() {
            this.inline ||
                !this.picker.active ||
