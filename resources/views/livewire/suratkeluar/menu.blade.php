      ...
      <div class="col-12 col-xl-12">
          <div class="card card-body bg-white border-light shadow-sm mb-3">
            <div class="d-flex my-1">
              <a href="{{ route('suratkeluar.create') }}" class="btn btn-icon btn-pill btn-outline-light text-twitter mr-2" type="button" aria-label="facebook button">
                  <span aria-hidden="true" class="fas fa-plus-circle"></span>
                  Tambah Data
              </a>
              <a href="{{ route('suratkeluar') }}" class="btn btn-icon btn-pill btn-outline-light text-twitter mr-2" type="button" aria-label="twitter button">
