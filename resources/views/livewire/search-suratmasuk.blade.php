                ...
                <div class="d-xl-flex align-items-center">
                    <div class="file-field">
                        <div class="d-flex justify-content-xl-center ml-xl-1">
                            <div class="d-flex">
                                <a target="_blank" href="{{ url('file/surat_masuk/',$data->file_surat_masuk) }}" data-toggle="tooltip" data-placement="top" title="Lihat File surat {{ $data['file_surat_masuk'] }}">
                                ...
                                <a wire:click="deletesm({{ $data->id }})" data-toggle="tooltip" data-placement="top" title="Delete data ini">
...
<livewire:suratmasuk.tambah-data />